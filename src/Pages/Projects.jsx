    ...
    return (
        <div id="project" className='bg-[aliceblue] pt-[60px]'>
            ...
            <div className='flex w-[80%] justify-center items-center m-auto flex-wrap'>
                {
                    data.map((pro, i) => (
                        <div key={i} className='container my-[20px] bg-blue-500 overflow-hidden hover:shadow-[0_10px_20px_gray]  relative flex sm:w-[calc(50%-10px)] lg:w-[calc(33.33%-10px)] flex-col h-[50vw] md:h-[18vw] justify-center border-gray border-[2px] m-auto rounded-3xl'>
